...
typedef real_number_t (*fractal_calculate_point_t)(const complex_number_t position, const ordinal_number_t iteration_steps, const ordinal_number_t argc, const real_number_t argv[]);


/* Function types for the output function plugin. */
//typedef int (*output_initialize_view_port)(const view_dimension_t dimension, const char *output_args);
...
/* Some functions which are put into plugins later. */
real_number_t fractal_calculate_point_mandelbrot(const complex_number_t position, const ordinal_number_t iteration_steps, const ordinal_number_t argc, const real_number_t argv[])
{
